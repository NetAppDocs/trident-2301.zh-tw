...
IMPORTANT: Kubernetes 1.26現在已在Trident中受到支援。升級Kubernetes之前、請先升級Astra Trident。
...
* 修正設定時拉出自動支援影像的問題 `imageRegistry` 安裝期間標示。（link:https://github.com/NetApp/trident/issues/715["GitHub問題#715"^]）
